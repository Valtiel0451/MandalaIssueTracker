...
namespace MandalaIssueTrackerMVC.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProjId,Name,Description,StatusId,ManagerId")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProjId,Name,Description,StatusId,ManagerId")] Project project)
        {
